...
export class GraphStaking__allocationsResult {
  value0: Address;
  value1: Bytes;
  value2: BigInt;
  value3: BigInt;
...
export class GraphStaking__delegationPoolsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GraphStaking__getAllocationResultValue0Struct extends ethereum.Tuple {
  get indexer(): Address {
...
export class GraphStaking__getDelegationResultValue0Struct extends ethereum.Tuple {
  get shares(): BigInt {
...
export class GraphStaking__getWithdraweableDelegatedTokensInput_delegationStruct extends ethereum.Tuple {
  get shares(): BigInt {
    return this[0].toBigInt();
  }
...
export class GraphStaking__rebatesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GraphStaking__stakesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GraphStaking extends ethereum.SmartContract {
  static bind(address: Address): GraphStaking {
    return new GraphStaking("GraphStaking", address);
  }

  allocations(param0: Address): GraphStaking__allocationsResult {
    ...
    return new GraphStaking__allocationsResult(
      result[0].toAddress(),
      result[1].toBytes(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_allocations(
    param0: Address
  ): ethereum.CallResult<GraphStaking__allocationsResult> {
    ...
    return ethereum.CallResult.fromValue(
      new GraphStaking__allocationsResult(
        value[0].toAddress(),
        value[1].toBytes(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  delegationPools(param0: Address): GraphStaking__delegationPoolsResult {
    let result = super.call(
      "delegationPools",
    ...
    return new GraphStaking__delegationPoolsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_delegationPools(
    param0: Address
  ): ethereum.CallResult<GraphStaking__delegationPoolsResult> {
    let result = super.tryCall(
      "delegationPools",
      "delegationPools(address):(uint32,uint32,uint32,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GraphStaking__delegationPoolsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getAllocation(
  ...
  ): GraphStaking__getAllocationResultValue0Struct {
    let result = super.call(
      "getAllocation",
    ...
    return changetype<GraphStaking__getAllocationResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getAllocation(
    _allocationID: Address
  ): ethereum.CallResult<GraphStaking__getAllocationResultValue0Struct> {
    let result = super.tryCall(
      "getAllocation",
      "getAllocation(address):((address,bytes32,uint256,uint256,uint256,uint256,uint256,uint256))",
      [ethereum.Value.fromAddress(_allocationID)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<GraphStaking__getAllocationResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getDelegation(
    _indexer: Address,
    _delegator: Address
  ): GraphStaking__getDelegationResultValue0Struct {
    let result = super.call(
      "getDelegation",
    ...
    return changetype<GraphStaking__getDelegationResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getDelegation(
    _indexer: Address,
    _delegator: Address
  ): ethereum.CallResult<GraphStaking__getDelegationResultValue0Struct> {
    let result = super.tryCall(
      "getDelegation",
      "getDelegation(address,address):((uint256,uint256,uint256))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<GraphStaking__getDelegationResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getWithdraweableDelegatedTokens(
    _delegation: GraphStaking__getWithdraweableDelegatedTokensInput_delegationStruct
  ): BigInt {
    let result = super.call(
      "getWithdraweableDelegatedTokens",
  ...
  rebates(param0: BigInt): GraphStaking__rebatesResult {
    let result = super.call(
      "rebates",
    ...
    return new GraphStaking__rebatesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebates(
    param0: BigInt
  ): ethereum.CallResult<GraphStaking__rebatesResult> {
    let result = super.tryCall(
      "rebates",
      "rebates(uint256):(uint256,uint256,uint256,uint32,uint32,uint32)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GraphStaking__rebatesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  stakes(param0: Address): GraphStaking__stakesResult {
    let result = super.call(
      "stakes",
    ...
    return new GraphStaking__stakesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_stakes(param0: Address): ethereum.CallResult<GraphStaking__stakesResult> {
    let result = super.tryCall(
      "stakes",
      "stakes(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GraphStaking__stakesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
